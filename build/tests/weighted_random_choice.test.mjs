...
const layout = {
    ...
    walls: [],
    shelves: [
        { id: 'left', label: 'Left', category: 'snack', x: 1.2, y: 1.2, w: 1, h: 1, valence: -0.9 },
        { id: 'right', label: 'Right', category: 'snack', x: 5.8, y: 1.2, w: 1, h: 1, valence: 0.9 },
    ],
...
const parameters = {
    topKChoices: 2,
    weightedRandomSharpness: 1.0,
    decisionNoise: 0,
    utilityNeedWeight: 0,
    utilityExploreWeight: 0,
    utilityValenceWeight: 4,
    distancePenalty: 0,
};
...
for (let seed = 1; seed <= 40; seed++) {
    const simulation = new LiveSimulation({
        ...
        parameters: { topKChoices: 1, weightedRandomSharpness: 1.0, decisionNoise: 0, utilityNeedWeight: 0, utilityExploreWeight: 0, utilityValenceWeight: 4, distancePenalty: 0 },
        seed,
        durationMinutes: 1,
    });
    simulation.decide(simulation.agents[0]);
