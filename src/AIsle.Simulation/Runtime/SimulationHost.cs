    ...
    public sealed class SimulationHost
    {
        ...
        public void Decide(NPCRuntimeState agent)
        {
            ...
            for (var shelfIndex = 0; shelfIndex < shelves.Length; shelfIndex++)
            {
                ...
                candidates.Add(new UtilityCandidate { Shelf = shelf, Path = access.Path, Target = access.Point, Total = evaluation.Total + noise });
            }
        ...
        private sealed class UtilityCandidate{public ShelfDefinition Shelf;public List<Position2D> Path;public Position2D Target;public double Total;}
    }
}
