...
5. Phạm vi hiện tại gồm Population foundation theo `docs/run.md`: Contracts, `NPCProfile`, Population/GA, Validator, Statistics và Golden Population Tests. Không triển khai UI/UX, NPC runtime, Utility AI, Interaction Zone, ORCA/RVO2, Social, DOTS, Burst hoặc Spine cho đến khi chủ dự án mở rộng phạm vi.
